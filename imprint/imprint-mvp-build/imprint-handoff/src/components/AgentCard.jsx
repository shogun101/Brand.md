/**
 * AgentCard — Selectable agent persona card
 *
 * Visual: 120×137px, rounded-3xl, image background with gradient overlay,
 *         name + role label at bottom. Selected state adds white border glow.
 *
 * @param {Object}   props
 * @param {string}   props.name       – Display name (e.g. "STRATEGIST")
 * @param {string}   props.role       – Sub-label (e.g. "Big Picture")
 * @param {string}   props.image      – Background image URL
 * @param {string}   [props.overlay]  – Optional overlay image URL (for selected state glow)
 * @param {boolean}  [props.selected] – Is this card the active selection?
...
export default function AgentCard({
  ...
  return (
    ...
    >
      ...
      {/* ── Text labels ── */}
      <div className="absolute bottom-[16px] left-[11px] flex w-[96px] flex-col items-start gap-[6px] text-center">
        <span
